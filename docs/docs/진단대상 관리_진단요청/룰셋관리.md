...
<center>
    <img
        src="../../../assets/images/진단룰셋_룰셋추가2.png"
        width="1600"
        height="900"
        style="border: 2px solid black;"
    />
...
진단에 사용하고 싶은 룰셋만 선택하고 <img src="../../../assets/images/button/저장버튼.png" alt="description" style="vertical-align:middle width:15px; height:15px;"> 버튼을 클릭하여 저장합니다. 
